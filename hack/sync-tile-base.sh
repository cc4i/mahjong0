...
aws s3 cp ${cdk_tile_tgz} s3://${s3_bucket}/tiles-repo/tile/cdk-tile.tgz --profile ${aws_profile}
...
aws s3 cp ${app_tile_tgz} s3://${s3_bucket}/tiles-repo/tile/app-tile.tgz --profile ${aws_profile}
